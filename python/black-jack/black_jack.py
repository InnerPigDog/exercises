...
def value_of_ace(card_one, card_two):
    ...
    ace_bonus = 10 if card_one == "A" else 0
    ace_bonus += 10 if card_two == "A" else 0
    if value_of_card(card_one) + value_of_card(card_two) + 10 + ace_bonus <= 21: 
        return 11
    else:
        return 1
...
def is_blackjack(card_one, card_two):
    ...
    ace_bonus = 10 if card_one == "A" else 0
    ace_bonus += 10 if card_two == "A" else 0
    return value_of_card(card_one) + value_of_card(card_two) + ace_bonus == 21 
